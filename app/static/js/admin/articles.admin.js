...
$(document).ready(function () {
  ...
  // Data formattata come GG/MM/AAAA → convertirla in YYYY-MM-DD
  ...
  $("#article-date").attr("min", todayStr)

  $("#article-date").change(function () {
    const selectedDate = $("#article-date").val();

    // Ottieni la data e ora nel fuso orario Europe/Rome
    ...
    // Ora formattata → somma 2 ore manualmente
    ...
    console.log(selectedDate, todayStr)

    if (selectedDate === todayStr) {
      $("#article-time").attr("min", currentTime);
    } else {
      $("#article-time").removeAttr("min");
    }
  });
